# ============================================================
# 104_isolated_preHTN_integrated_diet_metabolic_cluster.py
#
# Diet-metabolic integrated clustering within isolated preHTN
# ============================================================
...
df = df[
    df["exclusive_predisease_group"] == "isolated_preHTN"
].copy()

print("\n[ISOLATED preHTN ONLY]")
print(df.shape)
# mild metabolic outlier exclusion
...
profile.to_csv(
    os.path.join(
        OUT_DIR,
        "104_integrated_feature_profile.csv"
    ),
    encoding="utf-8-sig"
)
...
food_profile.to_csv(
    os.path.join(
        OUT_DIR,
        "104_integrated_food_profile.csv"
    ),
    encoding="utf-8-sig"
)
...
metabolic_profile.to_csv(
    os.path.join(
        OUT_DIR,
        "104_integrated_metabolic_profile.csv"
    ),
    encoding="utf-8-sig"
)
...
explained.to_csv(
    os.path.join(
        OUT_DIR,
        "104_integrated_pca_explained.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
loadings.to_csv(
    os.path.join(
        OUT_DIR,
        "104_integrated_pca_loadings.csv"
    ),
    encoding="utf-8-sig"
)
...
plt.savefig(
    os.path.join(
        OUT_DIR,
        "104_integrated_pca_cluster_plot.png"
    ),
    dpi=300,
    bbox_inches="tight"
)
...
plt.title(
    "Food profile by integrated preHTN phenotype"
)
...
plt.savefig(
    os.path.join(
        OUT_DIR,
        "104_integrated_food_profile_heatmap.png"
    ),
    dpi=300,
    bbox_inches="tight"
)
...
plt.title(
    "Metabolic profile by integrated preHTN phenotype"
)
...
plt.savefig(
    os.path.join(
        OUT_DIR,
        "104_integrated_metabolic_profile_heatmap.png"
    ),
    dpi=300,
    bbox_inches="tight"
)
...
plt.title(
    "Integrated diet-metabolic profile within isolated preHTN group"
)
...
plt.savefig(
    os.path.join(
        OUT_DIR,
        "104_integrated_combined_profile_heatmap.png"
    ),
    dpi=300,
    bbox_inches="tight"
)
