...
OUT_DIR = r"D:\precision_nutrition\FFQ\results\48_sex_stratified_prediabetes"
...
for sex_value, sex_label in [(1, "Male"), (2, "Female")]:
    ...
    print(tmp["glucose_group"].value_counts())
    ...
    shap_df.to_csv(
        f"{OUT_DIR}/{sex_label}_prediabetes_shap_summary.csv",
        index=False,
        encoding="utf-8-sig"
    )
...
perf.to_csv(
    f"{OUT_DIR}/48_prediabetes_sex_stratified_performance.csv",
    index=False,
    encoding="utf-8-sig"
)
