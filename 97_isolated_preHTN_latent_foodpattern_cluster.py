# ============================================================
# 97_isolated_preHTN_latent_foodpattern_cluster.py
#
# PCA + KMeans clustering within
# mutually exclusive isolated preHTN group
# ============================================================
...
food_profile.to_csv(
    os.path.join(
        OUT_DIR,
        "97_isolated_preHTN_food_profile.csv"
    ),
    encoding="utf-8-sig"
)
...
sil_df.to_csv(
    os.path.join(
        OUT_DIR,
        "97_isolated_preHTN_silhouette.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
plt.title("Dietary subtype clustering within isolated preHTN group")
...
plt.title("Food-group profile by isolated preHTN subtype")
