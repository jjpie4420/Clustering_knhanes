...
OUT_DIR = r"D:\precision_nutrition\FFQ\results\41_borderline_lipid_dependence"
...
summary.to_csv(
    f"{OUT_DIR}/41_borderline_lipid_top_features.csv",
    index=False,
    encoding="utf-8-sig"
)
...
quantile_summary.to_csv(
    f"{OUT_DIR}/41_borderline_lipid_quantile_shap_summary.csv",
    index=False,
    encoding="utf-8-sig"
)
