...
OUT_DIR = r"D:\precision_nutrition\FFQ\results\46_prediabetes_foodgroup_shap"
...
summary.to_csv(
    f"{OUT_DIR}/46_prediabetes_shap_summary.csv",
    index=False,
    encoding="utf-8-sig"
)
...
plt.tight_layout()
plt.savefig(
    f"{OUT_DIR}/46_prediabetes_shap_summary_plot.png",
    dpi=300,
    bbox_inches="tight"
)
plt.close()
...
quantile_summary.to_csv(
    f"{OUT_DIR}/46_prediabetes_quantile_shap_summary.csv",
    index=False,
    encoding="utf-8-sig"
)
