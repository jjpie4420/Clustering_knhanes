# ============================================================
# 95_isolated_lipid_latent_foodpattern_cluster.py
#
# PCA + KMeans clustering within
# mutually exclusive isolated borderline lipid group
# ============================================================
...
food_profile.to_csv(
    os.path.join(
        OUT_DIR,
        "95_isolated_lipid_food_profile.csv"
    ),
    encoding="utf-8-sig"
)
...
sil_df.to_csv(
    os.path.join(
        OUT_DIR,
        "95_isolated_lipid_silhouette.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
plt.title("Dietary subtype clustering within isolated lipid group")
...
plt.title("Food-group profile by isolated lipid subtype")
