# ============================================================
# 83_lipid_cluster_guideline_score_compare.py
#
# borderline lipid dietary subtype별 guideline-based dietary score 비교
...
OUT_DIR = os.path.join(
    BASE_DIR,
    "results",
    "83_lipid_cluster_guideline_score_compare"
)
...
summary.to_csv(
    os.path.join(
        OUT_DIR,
        "83_lipid_cluster_guideline_score_summary.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
tests.to_csv(
    os.path.join(
        OUT_DIR,
        "83_lipid_cluster_guideline_score_tests.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
posthoc.to_csv(
    os.path.join(
        OUT_DIR,
        "83_lipid_cluster_guideline_score_posthoc.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
df.to_csv(
    os.path.join(
        OUT_DIR,
        "83_lipid_cluster_guideline_score_dataset.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
