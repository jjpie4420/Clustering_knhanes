# ============================================================
# 81_lipid_cluster_metabolic_anova.py
#
# borderline lipid dietary subtype별 metabolic profile 비교
# - ANOVA
# - Kruskal-Wallis
...
summary.to_csv(
    os.path.join(
        OUT_DIR,
        "81_lipid_cluster_metabolic_profile_summary.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
tests.to_csv(
    os.path.join(
        OUT_DIR,
        "81_lipid_cluster_metabolic_profile_tests.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
