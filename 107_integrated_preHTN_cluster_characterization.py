# ============================================================
# 107_integrated_preHTN_cluster_characterization.py
#
# Characterization of integrated preHTN phenotypes
# Purpose:
...
OUT_DIR = os.path.join(
    BASE_DIR,
    "results",
    "107_integrated_preHTN_cluster_characterization"
)
...
manual_label_map = {
    1: "Prudent-balanced phenotype",
    2: "Beverage/lifestyle burden phenotype",
    3: "High-intake metabolically resilient phenotype",
    4: "Refined dietary phenotype",
}
...
# 보기 좋은 순서
col_order = [
    "Prudent-balanced phenotype",
    "Beverage/lifestyle burden phenotype",
    "High-intake metabolically resilient phenotype",
...
plt.title(
    "Integrated preHTN phenotype characterization\n"
...
plt.savefig(
    os.path.join(
        OUT_DIR,
        "107_integrated_preHTN_characterization_heatmap.png"
    ),
    dpi=300,
    bbox_inches="tight"
)
...
summary_df.to_csv(
    os.path.join(
        OUT_DIR,
        "107_integrated_preHTN_summary.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
test_df.to_csv(
    os.path.join(
        OUT_DIR,
        "107_integrated_preHTN_tests.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
posthoc_df.to_csv(
    os.path.join(
        OUT_DIR,
        "107_integrated_preHTN_posthoc.csv"
    ),
    index=False,
    encoding="utf-8-sig"
)
...
heatmap_df.to_csv(
    os.path.join(
        OUT_DIR,
        "107_integrated_preHTN_heatmap_raw.csv"
    ),
    encoding="utf-8-sig"
)
...
heatmap_z.to_csv(
    os.path.join(
        OUT_DIR,
        "107_integrated_preHTN_heatmap_zscore.csv"
    ),
    encoding="utf-8-sig"
)
