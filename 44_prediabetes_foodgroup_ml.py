...
OUT_DIR = r"D:\precision_nutrition\FFQ\results\44_prediabetes_foodgroup_ml"
...
summary.to_csv(
    f"{OUT_DIR}/44_prediabetes_foodgroup_ml_summary.csv",
    index=False,
    encoding="utf-8-sig"
)
...
importance.to_csv(
    f"{OUT_DIR}/44_xgb_foodgroup_importance.csv",
    index=False,
    encoding="utf-8-sig"
)
